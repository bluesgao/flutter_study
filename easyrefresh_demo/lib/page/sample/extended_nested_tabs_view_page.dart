...
class ExtendedNestedTabsViewPage extends StatefulWidget {
  const ExtendedNestedTabsViewPage({super.key});

  @override
  ExtendedNestedTabsViewPageState createState() {
    return ExtendedNestedTabsViewPageState();
  }
}

class ExtendedNestedTabsViewPageState extends State<ExtendedNestedTabsViewPage>
  ...
  Widget _buildNestedScrollView() {
    ...
    return ExtendedNestedScrollView(
      //滚动位置不会被销毁，设置 onlyOneScrollInBody 为 true，以便我们知道哪个列表是激活的。
      ...
      body: Column(
        children: [
          Expanded(child: _buildCustomTabBarView()),
          //底部间隔
