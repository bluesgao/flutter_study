import 'package:easyrefresh_demo/config/routes.dart';
import 'package:easyrefresh_demo/page/sample/test_page.dart';
import 'package:easyrefresh_demo/widget/list_item.dart';
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ListItem(
                ...
                icon: Icons.style,
                onTap: () => Get.toNamed(Routes.nestedTabsSample),
              ),
              ListItem(
                title: 'tabs view'.tr,
